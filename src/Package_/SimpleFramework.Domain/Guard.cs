...
using SimpleFramework.Domain.Exceptions;
...
namespace SimpleFramework.Domain
{
    public static class Guard
    {
        ...
        public static void Length(string source, int length, string paramName)
        {
            if (source.Length != length)
            {
                throw new LengthException(paramName, length);
            }
        }
        ...
        {
            if (source is null or default(decimal))
            {
                throw new NotNullException(name);
            }
        }
        ...
        {
            if (source is null or default(double))
            {
                throw new NotNullException(name);
            }
        }
        ...
        {
            if (source is null || source == Guid.Empty)
            {
                throw new NotNullException(name);
            }
        }
        ...
        {
            if (source is null || source == default(DateTime))
            {
                throw new NotNullException(name);
            }
        }
        ...
        {
            if (source is null || source == default(DateTimeOffset))
            {
                throw new NotNullException(name);
            }
        }
        ...
        public static void Digit(string source, string name)
        {
        ...
        public static void RangeInclusive<T>(T from, T to, T source, string name) where T : IComparable<T>
        {
            ...
            {
                throw new InvalidRangeException(name,from, to);
            }
        }
    }
}